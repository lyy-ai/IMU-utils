...
with open(filepath + '/imu_pose_noise.txt', 'r') as f:  # imu_circle   imu_spline
    ...
    for line in data:
        ...
        position_noise.append([numbers_float[tx_index], numbers_float[tx_index + 1], numbers_float[tx_index + 2]])


position1 = []
quaterntions1 = []
timestamp1 = []
with open(filepath + '/imu_int_pose_1.txt', 'r') as f:  # imu_pose   imu_spline
...
quaterntions2 = []
timestamp2 = []
with open(filepath + '/imu_int_pose_noise_1.txt', 'r') as f:  # cam_pose_opt_o_0   cam_pose_opt_o_0
...
quaterntions3 = []
timestamp3 = []
with open(filepath + '/imu_int_pose_2.txt', 'r') as f:  # imu_pose   imu_spline
...
quaterntions4 = []
timestamp4 = []
with open(filepath + '/imu_int_pose_noise_2.txt', 'r') as f:  # cam_pose_opt_o_0   cam_pose_opt_o_0
...
xyz4 = zip(*position4)
print
ax.plot(xyz[0], xyz[1], xyz[2], label='gt_trajectory')
ax.plot(xyz1[0], xyz1[1], xyz1[2], label='imu_int_euler')
ax.plot(xyz2[0], xyz2[1], xyz2[2], label='imu_int__euler_noise')
ax.plot(xyz3[0], xyz3[1], xyz3[2], label='imu_int_mid')
ax.plot(xyz4[0], xyz4[1], xyz4[2], label='imu_int_mid_noise')
ax.legend()
